...
constructor(private actRoute: ActivatedRoute,
  ...
  async getBasicInformation(id: any)
  {
    ...
    await this.authService.getBasicInformationByBusinessPermitId(obj)
    .subscribe(data => 
      {
        var basicinformation = data.data[0]
        console.log("Basic information", basicinformation)
        this.createNewBusinessPermitFormGroup.controls['modeofpayment'].setValue(basicinformation.ModeOfPayment)
        this.createNewBusinessPermitFormGroup.controls['dateofapplication'].setValue(basicinformation.DateOfApplication)
        this.createNewBusinessPermitFormGroup.controls['tinno'].setValue(basicinformation.TinNo)
        this.createNewBusinessPermitFormGroup.controls['dtiseccdaregistrationnumber'].setValue(basicinformation.DtiSecCdaRegistrationNumber)
        this.createNewBusinessPermitFormGroup.controls['dtiseccdaregistrationdate'].setValue(basicinformation.DtiSecCdaRegistrationDate)
        this.createNewBusinessPermitFormGroup.controls['typeofbusiness'].setValue(basicinformation.TypeOfBusiness)
        this.createNewBusinessPermitFormGroup.controls['taxincentivegovernmententity'].setValue(basicinformation.TaxIncentiveGovernmentEntity)
        this.createNewBusinessPermitFormGroup.controls['specifytheentity'].setValue(basicinformation.SpecifyEntity)
    
    
        this.createNewBusinessPermitFormGroup.controls['taxpayerlastname'].setValue(basicinformation.TaxPayerLastName)
        this.createNewBusinessPermitFormGroup.controls['taxpayerfirstname'].setValue(basicinformation.TaxPayerFirstName)
        this.createNewBusinessPermitFormGroup.controls['taxpayermiddlename'].setValue(basicinformation.TaxPayerMiddleName)
        this.createNewBusinessPermitFormGroup.controls['taxpayerbusinessname'].setValue(basicinformation.TaxPayerBusinessName)
        this.createNewBusinessPermitFormGroup.controls['tradenamefranchise'].setValue(basicinformation.TradeNameFranchise)
  ...
  async getAmendment(id: any)
  {
    ...
    await this.authService.getAmendmentByBusinessPermitId(obj)
    .subscribe(data => 
      {
        var amendment = data.data[0]
        console.log("amendment", amendment)
        this.createNewBusinessPermitFormGroup.controls['from'].setValue(amendment.Mula)
        this.createNewBusinessPermitFormGroup.controls['to'].setValue(amendment.Hanggang
          )
  ...
  await this.authService.getotherInformationByBusinessPermitId(obj)
  .subscribe(data => 
    {
      var otherInformation = data.data[0]
      console.log("otherInformation", otherInformation)
      this.createNewBusinessPermitFormGroup.controls['businessaddress'].setValue(otherInformation.BusinessAddress)
      this.createNewBusinessPermitFormGroup.controls['businesspostalcode'].setValue(otherInformation.BusinessPostalCode)
      this.createNewBusinessPermitFormGroup.controls['businessemailaddress'].setValue(otherInformation.BusinessEmailAddress)
      this.createNewBusinessPermitFormGroup.controls['businesstelephone'].setValue(otherInformation.BusinessTelephoneNumber)
      this.createNewBusinessPermitFormGroup.controls['businessmobile'].setValue(otherInformation.BusinessMobileNumber)
      this.createNewBusinessPermitFormGroup.controls['ownersaddress'].setValue(otherInformation.OwnersAddress)
      this.createNewBusinessPermitFormGroup.controls['ownerspostalcode'].setValue(otherInformation.OwnersPostalCode)

      this.createNewBusinessPermitFormGroup.controls['ownersemailaddress'].setValue(otherInformation.OwnersEmailAddress)

      this.createNewBusinessPermitFormGroup.controls['ownerstelephone'].setValue(otherInformation.OwnersTelephoneNumber)

      this.createNewBusinessPermitFormGroup.controls['ownersmobile'].setValue(otherInformation.OwnersMobileNumber)

      this.createNewBusinessPermitFormGroup.controls['incaseofemergencyperson'].setValue(otherInformation.IncaseOfEmergencyContactPerson)

      this.createNewBusinessPermitFormGroup.controls['incaseofemergencypersontelephonenumber'].setValue(otherInformation.IncaseOfEmergencyPhoneorMobileNumber)

      this.createNewBusinessPermitFormGroup.controls['incaseofemergencypersonemail'].setValue(otherInformation.IncaseOfEmergencyEmailAddress)

      this.createNewBusinessPermitFormGroup.controls['incaseofemergencypersonbusinessarea'].setValue(otherInformation.BusinessAreaInSqm)

      this.createNewBusinessPermitFormGroup.controls['grossreceipt'].setValue(otherInformation.GrossSalesReceipts)

      this.createNewBusinessPermitFormGroup.controls['totalnumberofmale'].setValue(otherInformation.TotalNoOfEmployeesMale)

      this.createNewBusinessPermitFormGroup.controls['totalnumberoffemale'].setValue(otherInformation.TotalNoOfEmployeesFemale)

      this.createNewBusinessPermitFormGroup.controls['numberofemployeeslgu'].setValue(otherInformation.NumberOfEmployeesResidingLGU)

      this.createNewBusinessPermitFormGroup.controls['lessorsfullname'].setValue(otherInformation.LessorsFullname)

      this.createNewBusinessPermitFormGroup.controls['lessorsaddress'].setValue(otherInformation.LessorsAddress)

      
      this.createNewBusinessPermitFormGroup.controls['lessorstelorphone'].setValue(otherInformation.LessorsTelephoneMobileNumber)
      
      this.createNewBusinessPermitFormGroup.controls['lessorsemail'].setValue(otherInformation.LessorsEmailAddress)
      
      this.createNewBusinessPermitFormGroup.controls['monthlyrental'].setValue(otherInformation.LessorsMonthlyRental)
  ...
  async lineOfBusiness(id: any)
  {
    ...
    await this.authService.getLineofBusinessByBusinessPermitId(obj).subscribe(data => 
      {
